...
object UserServices : Table("USER_SERVICE") {
  ...
  val userId: Column<Int> = UserServices.integer("user_id")
    .references(Users.id, ReferenceOption.CASCADE, ReferenceOption.CASCADE)
  val serviceId: Column<Int> = UserServices.integer("service_id")
    .references(ServiceInfos.id, ReferenceOption.CASCADE, ReferenceOption.CASCADE)
